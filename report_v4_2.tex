...
In this section the heuristic algorithm was implemented and a initial testing was carried out using the Random Instance Generator from section 4. A combination of Guaranteed-solution and Random-target mode was used. An epsilon of 0.10 was used to have a relatively close approximation whilst at the same time not taking too long to compute.
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}rrrrccc@{}}
    ...
    \bottomrule
  \end{tabular}
  \caption{Performance testing results for \texttt{fptas\_subset\_sum} with \(\epsilon = 0.10\). The value \(b\) is the half-width of the 90\% confidence interval around the mean runtime.}
...
\begin{figure}[H]
    ...
    \caption{log runtime vs input size graph}
